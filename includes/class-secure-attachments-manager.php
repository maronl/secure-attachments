 ...
 * @since 1.0.0
 */
class Secure_Attachments_Manager {
    ...
    public function __construct() {
        ...
        $this->plugin_slug = 'secure-attachments-slug';
        $this->version = '1.0.0';
    ...
    private function load_dependencies() {
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'lib/class-secure-attachments.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-secure-attachments-manager-admin.php';
        //require_once plugin_dir_path( dirname( __FILE__ ) ) . 'lib/class-secure-attachment.php';
...
//        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-single-post-meta-manager-public.php';
        ...
        require_once plugin_dir_path( __FILE__ ) . 'class-secure-attachments-loader.php';
        $this->loader = new Secure_Attachments_Loader();
